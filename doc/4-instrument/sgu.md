...
- **Sound Unit**: for sample settings and the hardware sweeps.
...
this tab controls sample settings and the hardware sweeps.
...
the hardware sweeps allows automating sweep parameters. the available commands are:
