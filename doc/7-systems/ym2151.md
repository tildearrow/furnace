...
- `66xx`: **set TL ramp time for this channel**.
  - this feature is exclusive to the YM2164 (OPP) chip.
...
- **Chip type**: select between YM2151 and YM2164.
  - YM2151 (OPM): the original.
  - YM2164 (OPP): a variant used in some Yamaha synthesizers and Commander X16 computers. features a new TL ramp setting.
