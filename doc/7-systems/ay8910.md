...
it is a 3-channel square/noise/envelope sound generator. the noise and envelope frequencies are shared among all channels.
the chip's power lies in its hardware envelope, capable of being clocked high enough to produce bass tones.
...
- **Chip type**: changes the chip model.
  ...
  - YM2149(F): a Yamaha clone released in 1983. it's almost identical to AY with minor differences being: higher hardware envelope step resolution (16 vs 32), half-clock mode when voltage level is low, much stronger DC offset, and cleaner but softer output.
  - Sunsoft 5B: a YM2149 clone with half-clock mode forced on, found in one of Sunsoft's Famicom cartridges.
  - AY-3-8914: an 8910 with 4-level envelope volume per channel and different register format. found in the Intellivision.
