      ...
      <body>
        ...
        <section id="authors">
          ...
          <div>
            ...
            <p>this manual is written for version Hyper ESFMing of Furnace.<br/>it may not necessarily apply to previous or future versions.</p>
        </section>
        <section id="index">
          %s
        </section>
