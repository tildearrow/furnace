...
enum DivDispatchCmds {
  ...
  DIV_CMD_REMOVED_SPECIAL_WAVE,
  DIV_CMD_REMOVED_RING_MOD_SRC,
  DIV_CMD_REMOVED_HARD_SYNC_SRC,
  DIV_CMD_REMOVED_PHASE_MOD_SRC,
  DIV_CMD_REMOVED_WAVE_MIX,
  DIV_CMD_REMOVED_LFSR_FEEDBACK_BITS,
  DIV_CMD_REMOVED_1_BIT_NOISE,
  DIV_CMD_REMOVED_FILTER_DISTORTION,
  DIV_CMD_REMOVED_FILTER_OUTPUT_VOLUME,
  DIV_CMD_REMOVED_CHANNEL_INVERSION,
  DIV_CMD_REMOVED_FILTER_CONNECTION,
  DIV_CMD_REMOVED_FILTER_MATRIX,
  DIV_CMD_REMOVED_FILTER_ENABLE,

  DIV_CMD_C64_PW_SLIDE,
  DIV_CMD_C64_CUTOFF_SLIDE,

  DIV_CMD_REMOVED_PHASE_RESET,
  DIV_CMD_REMOVED_NOISE_PHASE_RESET,
  DIV_CMD_REMOVED_ENVELOPE_RESET,

  DIV_CMD_REMOVED_CUTOFF_SCALING,
  DIV_CMD_REMOVED_RESONANCE_SCALING,
