...
enum DivDispatchCmds {
  ...
  DIV_CMD_FM_LFOA_RATE,
  DIV_CMD_FM_LFOA_FMDEPTH,
  DIV_CMD_FM_LFOA_AMDEPTH,
  DIV_CMD_FM_LFOA_WAVEFORM,
  DIV_CMD_FM_LFOA_NOISE,
  DIV_CMD_FM_LFOA_SYNC,

  DIV_CMD_FM_LFOB_RATE,
  DIV_CMD_FM_LFOB_FMDEPTH,
  DIV_CMD_FM_LFOB_AMDEPTH,
  DIV_CMD_FM_LFOB_WAVEFORM,
  DIV_CMD_FM_LFOB_NOISE,
  DIV_CMD_FM_LFOB_SYNC,
