...
void DivEngine::registerSystems() {
  ...
  sysDefs[DIV_SYSTEM_KLATTSCH]=new DivSysDef(
    ...
    DivChanDefFunc(simpleChanDef<DIV_CH_NOISE,DIV_INS_STD>),
    {
      ...
      {0x18, {DIV_CMD_KLATTSCH_VOICING, _("18xx: Set voicing (00-FE; FF: phoneme default; sticky)")}},
      {0x19, {DIV_CMD_KLATTSCH_ASPIRATION, _("19xx: Set aspiration (00-FE; FF: phoneme default; sticky)")}},
      {0x1A, {DIV_CMD_KLATTSCH_TILT, _("1Axx: Set spectral tilt (signed; 00-7F: positive, 80-FE: negative; FF: phoneme default; sticky)")}},
      {0x1B, {DIV_CMD_KLATTSCH_EFFORT, _("1Bxx: Set glottal effort (00-FE; FF: phoneme default; sticky)")}},
      ...
      {0x1E, {DIV_CMD_KLATTSCH_GAIN, _("1Exx: Set gain (01-FF: xx/16; 00: phoneme default; sticky)")}},
      {0x1F, {DIV_CMD_KLATTSCH_BW_SCALE, _("1Fxx: Formant bandwidth scale (01-FF: xx/64; 00: neutral; sticky)")}},
      {0x20, {DIV_CMD_KLATTSCH_FORMANT_SHIFT, _("20xx: Formant shift (01-FF: xx/64; 00: neutral; sticky)")}},
    }
  );
