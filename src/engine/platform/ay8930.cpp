...
void DivPlatformAY8930::notifyPitchTable(int sample) {
  samplePitchTable.update<Channel>(chan,3,parent->song.tuning,chipClock,CHIP_DIVIDER,0xffff,true,parent->song.compatFlags.linearPitch,sample);
  if (sample==-1) {
