...
SharedChannel* DivPlatformYM2608Ext::getChanState(int ch) {
...
unsigned int DivPlatformYM2608Ext::getMaxFreq(int ch) {
  if (ch>5) return DivPlatformYM2608::getMaxFreq(ch-3);
  return 0x3fff;
}
