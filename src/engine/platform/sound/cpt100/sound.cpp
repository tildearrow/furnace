...
static double t1[4] = {0,0,0,0};
static double t2[4] = {0,0,0,0};
static double t3[4] = {0,0,0,0};
static double t4[4] = {0,0,0,0};
static double twt[2] = {0,0};
static double in1[2]  = {0.0,0.0};
static double in2[2]  = {0.0,0.0};
static double out1[2] = {0.0,0.0};
static double out2[2] = {0.0,0.0};
static std::vector<int> gateTick = {0,0,0,0};
static std::vector<Byte> reg,regenvl,regwt;
static std::vector<int> noise;
static std::vector<EnvGenerator> envl;
static EnvGenerator _envl;
