...
#ifndef MAME_SOUND_OKIM5205_H
#define MAME_SOUND_OKIM5205_H
...
class okim5205_device {
public:
	static constexpr int FOSC_DIV_BY_128     = 2;
	...
	okim5205_device(uint32_t clock);
