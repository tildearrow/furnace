...
void FurnaceGUI::drawInsT6W28(DivInstrument* ins)
{
  if (ImGui::BeginTabItem("Macros")) 
  {
    ...
    macroList.push_back(FurnaceGUIMacroDesc("Panning (left)",ins,DIV_MACRO_PAN_LEFT,0xff,0,panMax,CLAMP(31+panMax-panMin,32,160),uiColors[GUI_COLOR_MACRO_OTHER],false,(ins->type==DIV_INS_AMIGA)?macroQSoundMode:NULL));
    ...
    macroList.push_back(FurnaceGUIMacroDesc("Noise Type",ins,DIV_MACRO_DUTY,0xff,0,1,32,uiColors[GUI_COLOR_MACRO_OTHER]));
