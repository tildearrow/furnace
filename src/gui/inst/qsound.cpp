...
void FurnaceGUI::drawInsQSOUND(DivInstrument* ins)
{
  ...
  if (ImGui::BeginTabItem("Macros")) 
  {
    ...
    macroList.push_back(FurnaceGUIMacroDesc("Volume",ins,DIV_MACRO_VOL,0xff,0,16383,160,uiColors[GUI_COLOR_MACRO_VOLUME]));
    ...
    macroList.push_back(FurnaceGUIMacroDesc("Echo Level",ins,DIV_MACRO_DUTY,0xff,0,32767,160,uiColors[GUI_COLOR_MACRO_OTHER]));
    macroList.push_back(FurnaceGUIMacroDesc("Echo Feedback",ins,DIV_MACRO_EX1,0xff,0,16383,160,uiColors[GUI_COLOR_MACRO_OTHER]));
    macroList.push_back(FurnaceGUIMacroDesc("Echo Length",ins,DIV_MACRO_EX2,0xff,0,2725,160,uiColors[GUI_COLOR_MACRO_OTHER]));
