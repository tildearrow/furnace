...
void FurnaceGUI::drawInsC219(DivInstrument* ins)
{
  ...
  if (ImGui::BeginTabItem("Macros")) 
  {
    ...
    macroList.push_back(FurnaceGUIMacroDesc("Control",ins,DIV_MACRO_DUTY,0xff,0,dutyMax,120,uiColors[GUI_COLOR_MACRO_OTHER],false,NULL,NULL,true,c219ControlBits));
