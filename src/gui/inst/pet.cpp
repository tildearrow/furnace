...
void FurnaceGUI::drawInsPET(DivInstrument* ins)
{
  ...
  {
    macroList.push_back(FurnaceGUIMacroDesc("Volume",ins,DIV_MACRO_VOL,0xff,0,1,32,uiColors[GUI_COLOR_MACRO_VOLUME]));
    ...
    macroList.push_back(FurnaceGUIMacroDesc("Waveform",ins,DIV_MACRO_WAVE,0xff,0,8,128,uiColors[GUI_COLOR_MACRO_WAVE],false,NULL,NULL,true,NULL,0));
