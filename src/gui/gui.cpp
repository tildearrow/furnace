...
void FurnaceGUI::syncSettings() {
  ...
  LOAD_KEYBIND(GUI_ACTION_INS_LIST_EDIT,SDLK_RETURN);
  ...
  LOAD_KEYBIND(GUI_ACTION_WAVE_LIST_EDIT,SDLK_RETURN);
  ...
  LOAD_KEYBIND(GUI_ACTION_SAMPLE_LIST_EDIT,SDLK_RETURN);
