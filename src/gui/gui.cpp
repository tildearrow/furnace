  ...
  switch (type) {
    case GUI_FILE_OPEN:
      ...
      hasOpened=fileDialog->openLoad(
        _("Open File"),
        {_("compatible files"), "*.fur *.dmf *.mod *.s3m *.xm *.it *.fc13 *.fc14 *.smod *.fc *.ftm *.0cc *.dnm *.eft *.fub *.tfe *.a2m *.a2t",
         _("all files"), "*"},
        workingDirSong,
        dpiScale
      );
