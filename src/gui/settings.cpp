      ...
      CONFIG_SECTION(_("Color")) {
        ...
        if (settings.basicColors) {
          if (ImGui::TreeNode(_("Interface"))) {
            ...
            ImGui::Indent();
            UI_COLOR_CONFIG(GUI_COLOR_ACCENT_PRIMARY);
            UI_COLOR_CONFIG(GUI_COLOR_ACCENT_SECONDARY);
            ImGui::Unindent();
          ...
          if (ImGui::TreeNode(_("Interface"))) {
            ...
            UI_COLOR_CONFIG(GUI_COLOR_BUTTON);
            UI_COLOR_CONFIG(GUI_COLOR_BUTTON_HOVER);
            UI_COLOR_CONFIG(GUI_COLOR_BUTTON_ACTIVE);
            UI_COLOR_CONFIG(GUI_COLOR_TAB);
            UI_COLOR_CONFIG(GUI_COLOR_TAB_HOVER);
            UI_COLOR_CONFIG(GUI_COLOR_TAB_ACTIVE);
            UI_COLOR_CONFIG(GUI_COLOR_TAB_SELECTED_OVERLINE);
            UI_COLOR_CONFIG(GUI_COLOR_TAB_UNFOCUSED);
            UI_COLOR_CONFIG(GUI_COLOR_TAB_UNFOCUSED_ACTIVE);
            UI_COLOR_CONFIG(GUI_COLOR_TAB_DIMMED_SELECTED_OVERLINE);
            UI_COLOR_CONFIG(GUI_COLOR_IMGUI_HEADER);
            UI_COLOR_CONFIG(GUI_COLOR_IMGUI_HEADER_HOVER);
            UI_COLOR_CONFIG(GUI_COLOR_IMGUI_HEADER_ACTIVE);
            UI_COLOR_CONFIG(GUI_COLOR_RESIZE_GRIP);
            UI_COLOR_CONFIG(GUI_COLOR_RESIZE_GRIP_HOVER);
            UI_COLOR_CONFIG(GUI_COLOR_RESIZE_GRIP_ACTIVE);
            UI_COLOR_CONFIG(GUI_COLOR_WIDGET_BACKGROUND);
            UI_COLOR_CONFIG(GUI_COLOR_WIDGET_BACKGROUND_HOVER);
            UI_COLOR_CONFIG(GUI_COLOR_WIDGET_BACKGROUND_ACTIVE);
            UI_COLOR_CONFIG(GUI_COLOR_SLIDER_GRAB);
            UI_COLOR_CONFIG(GUI_COLOR_SLIDER_GRAB_ACTIVE);
            UI_COLOR_CONFIG(GUI_COLOR_TITLE_BACKGROUND_ACTIVE);
            UI_COLOR_CONFIG(GUI_COLOR_CHECK_MARK);
            UI_COLOR_CONFIG(GUI_COLOR_TEXT_LINK);
            UI_COLOR_CONFIG(GUI_COLOR_TEXT_SELECTION);
            UI_COLOR_CONFIG(GUI_COLOR_TREE_LINES);
            UI_COLOR_CONFIG(GUI_COLOR_PLOT_LINES);
            UI_COLOR_CONFIG(GUI_COLOR_PLOT_LINES_HOVER);
            UI_COLOR_CONFIG(GUI_COLOR_PLOT_HISTOGRAM);
            UI_COLOR_CONFIG(GUI_COLOR_PLOT_HISTOGRAM_HOVER);
            UI_COLOR_CONFIG(GUI_COLOR_TABLE_ROW_EVEN);
            UI_COLOR_CONFIG(GUI_COLOR_TABLE_ROW_ODD);

            ImGui::TreePop();
          }
        }
        if (ImGui::TreeNode(_("Interface (other)"))) {
          UI_COLOR_CONFIG(GUI_COLOR_BACKGROUND);
          UI_COLOR_CONFIG(GUI_COLOR_FRAME_BACKGROUND);
          UI_COLOR_CONFIG(GUI_COLOR_FRAME_BACKGROUND_CHILD);
          UI_COLOR_CONFIG(GUI_COLOR_FRAME_BACKGROUND_POPUP);
          UI_COLOR_CONFIG(GUI_COLOR_MODAL_BACKDROP);
          UI_COLOR_CONFIG(GUI_COLOR_HEADER);
          UI_COLOR_CONFIG(GUI_COLOR_TEXT);
          UI_COLOR_CONFIG(GUI_COLOR_TEXT_DISABLED);
          UI_COLOR_CONFIG(GUI_COLOR_TITLE_INACTIVE);
          UI_COLOR_CONFIG(GUI_COLOR_TITLE_COLLAPSED);
          UI_COLOR_CONFIG(GUI_COLOR_MENU_BAR);
          UI_COLOR_CONFIG(GUI_COLOR_BORDER);
          UI_COLOR_CONFIG(GUI_COLOR_BORDER_SHADOW);
          UI_COLOR_CONFIG(GUI_COLOR_SCROLL);
          UI_COLOR_CONFIG(GUI_COLOR_SCROLL_HOVER);
          UI_COLOR_CONFIG(GUI_COLOR_SCROLL_ACTIVE);
          UI_COLOR_CONFIG(GUI_COLOR_SCROLL_BACKGROUND);
          UI_COLOR_CONFIG(GUI_COLOR_SEPARATOR);
          UI_COLOR_CONFIG(GUI_COLOR_SEPARATOR_HOVER);
          UI_COLOR_CONFIG(GUI_COLOR_SEPARATOR_ACTIVE);
          UI_COLOR_CONFIG(GUI_COLOR_DOCKING_PREVIEW);
          UI_COLOR_CONFIG(GUI_COLOR_DOCKING_EMPTY);
          UI_COLOR_CONFIG(GUI_COLOR_TABLE_HEADER);
          UI_COLOR_CONFIG(GUI_COLOR_TABLE_BORDER_HARD);
          UI_COLOR_CONFIG(GUI_COLOR_TABLE_BORDER_SOFT);
          UI_COLOR_CONFIG(GUI_COLOR_DRAG_DROP_TARGET);
          UI_COLOR_CONFIG(GUI_COLOR_NAV_WIN_HIGHLIGHT);
          UI_COLOR_CONFIG(GUI_COLOR_NAV_WIN_BACKDROP);
          UI_COLOR_CONFIG(GUI_COLOR_INPUT_TEXT_CURSOR);
          ImGui::TreePop();
        }
        if (ImGui::TreeNode(_("Miscellaneous"))) {
          UI_COLOR_CONFIG(GUI_COLOR_TOGGLE_ON);
          UI_COLOR_CONFIG(GUI_COLOR_TOGGLE_OFF);
          UI_COLOR_CONFIG(GUI_COLOR_PLAYBACK_STAT);
          UI_COLOR_CONFIG(GUI_COLOR_DESTRUCTIVE);
          UI_COLOR_CONFIG(GUI_COLOR_WARNING);
          UI_COLOR_CONFIG(GUI_COLOR_ERROR);
          ImGui::TreePop();
        }
        if (ImGui::TreeNode(_("File Picker (built-in)"))) {
          UI_COLOR_CONFIG(GUI_COLOR_FILE_DIR);
          UI_COLOR_CONFIG(GUI_COLOR_FILE_SONG_NATIVE);
          UI_COLOR_CONFIG(GUI_COLOR_FILE_SONG_IMPORT);
          UI_COLOR_CONFIG(GUI_COLOR_FILE_INSTR);
          UI_COLOR_CONFIG(GUI_COLOR_FILE_AUDIO);
          UI_COLOR_CONFIG(GUI_COLOR_FILE_AUDIO_COMPRESSED);
          UI_COLOR_CONFIG(GUI_COLOR_FILE_WAVE);
          UI_COLOR_CONFIG(GUI_COLOR_FILE_VGM);
          UI_COLOR_CONFIG(GUI_COLOR_FILE_ZSM);
          UI_COLOR_CONFIG(GUI_COLOR_FILE_FONT);
          UI_COLOR_CONFIG(GUI_COLOR_FILE_OTHER);
          ImGui::TreePop();
        }
        if (ImGui::TreeNode(_("Oscilloscope"))) {
          UI_COLOR_CONFIG(GUI_COLOR_OSC_BORDER);
          UI_COLOR_CONFIG(GUI_COLOR_OSC_BG1);
          UI_COLOR_CONFIG(GUI_COLOR_OSC_BG2);
          UI_COLOR_CONFIG(GUI_COLOR_OSC_BG3);
          UI_COLOR_CONFIG(GUI_COLOR_OSC_BG4);
          UI_COLOR_CONFIG(GUI_COLOR_OSC_WAVE);
          UI_COLOR_CONFIG(GUI_COLOR_OSC_WAVE_PEAK);
          UI_COLOR_CONFIG(GUI_COLOR_OSC_REF);
          UI_COLOR_CONFIG(GUI_COLOR_OSC_GUIDE);

          if (ImGui::TreeNode(_("Wave (non-mono)"))) {
            UI_COLOR_CONFIG(GUI_COLOR_OSC_WAVE_CH0);
            UI_COLOR_CONFIG(GUI_COLOR_OSC_WAVE_CH1);
            UI_COLOR_CONFIG(GUI_COLOR_OSC_WAVE_CH2);
            UI_COLOR_CONFIG(GUI_COLOR_OSC_WAVE_CH3);
            UI_COLOR_CONFIG(GUI_COLOR_OSC_WAVE_CH4);
            UI_COLOR_CONFIG(GUI_COLOR_OSC_WAVE_CH5);
            UI_COLOR_CONFIG(GUI_COLOR_OSC_WAVE_CH6);
            UI_COLOR_CONFIG(GUI_COLOR_OSC_WAVE_CH7);
            UI_COLOR_CONFIG(GUI_COLOR_OSC_WAVE_CH8);
            UI_COLOR_CONFIG(GUI_COLOR_OSC_WAVE_CH9);
            UI_COLOR_CONFIG(GUI_COLOR_OSC_WAVE_CH10);
            UI_COLOR_CONFIG(GUI_COLOR_OSC_WAVE_CH11);
            UI_COLOR_CONFIG(GUI_COLOR_OSC_WAVE_CH12);
            UI_COLOR_CONFIG(GUI_COLOR_OSC_WAVE_CH13);
            UI_COLOR_CONFIG(GUI_COLOR_OSC_WAVE_CH14);
            UI_COLOR_CONFIG(GUI_COLOR_OSC_WAVE_CH15);
            ImGui::TreePop();
          }
          ImGui::TreePop();
        }
        if (ImGui::TreeNode(_("Volume Meter"))) {
          UI_COLOR_CONFIG(GUI_COLOR_VOLMETER_LOW);
          UI_COLOR_CONFIG(GUI_COLOR_VOLMETER_HIGH);
          UI_COLOR_CONFIG(GUI_COLOR_VOLMETER_PEAK);
          ImGui::TreePop();
        }
        if (ImGui::TreeNode(_("Orders"))) {
          UI_COLOR_CONFIG(GUI_COLOR_ORDER_ROW_INDEX);
          UI_COLOR_CONFIG(GUI_COLOR_ORDER_ACTIVE);
          UI_COLOR_CONFIG(GUI_COLOR_SONG_LOOP);
          UI_COLOR_CONFIG(GUI_COLOR_ORDER_SELECTED);
          UI_COLOR_CONFIG(GUI_COLOR_ORDER_SIMILAR);
          UI_COLOR_CONFIG(GUI_COLOR_ORDER_INACTIVE);
          ImGui::TreePop();
        }
        if (ImGui::TreeNode(_("Envelope View"))) {
          UI_COLOR_CONFIG(GUI_COLOR_FM_ENVELOPE);
          UI_COLOR_CONFIG(GUI_COLOR_FM_ENVELOPE_SUS_GUIDE);
          UI_COLOR_CONFIG(GUI_COLOR_FM_ENVELOPE_RELEASE);

          ImGui::TreePop();
        }
        if (ImGui::TreeNode(_("FM Editor"))) {
          UI_COLOR_CONFIG(GUI_COLOR_FM_ALG_BG);
          UI_COLOR_CONFIG(GUI_COLOR_FM_ALG_LINE);
          UI_COLOR_CONFIG(GUI_COLOR_FM_MOD);
          UI_COLOR_CONFIG(GUI_COLOR_FM_CAR);

          UI_COLOR_CONFIG(GUI_COLOR_FM_SSG);
          UI_COLOR_CONFIG(GUI_COLOR_FM_WAVE);

          ImGui::TextWrapped(_("(the following colors only apply when \"Use separate colors for carriers/modulators in FM editor\" is on!)"));

          UI_COLOR_CONFIG(GUI_COLOR_FM_PRIMARY_MOD);
          UI_COLOR_CONFIG(GUI_COLOR_FM_SECONDARY_MOD);
          UI_COLOR_CONFIG(GUI_COLOR_FM_BORDER_MOD);
          UI_COLOR_CONFIG(GUI_COLOR_FM_BORDER_SHADOW_MOD);

          UI_COLOR_CONFIG(GUI_COLOR_FM_PRIMARY_CAR);
          UI_COLOR_CONFIG(GUI_COLOR_FM_SECONDARY_CAR);
          UI_COLOR_CONFIG(GUI_COLOR_FM_BORDER_CAR);
          UI_COLOR_CONFIG(GUI_COLOR_FM_BORDER_SHADOW_CAR);

          ImGui::TreePop();
        }
        if (ImGui::TreeNode(_("Macro Editor"))) {
          UI_COLOR_CONFIG(GUI_COLOR_MACRO_VOLUME);
          UI_COLOR_CONFIG(GUI_COLOR_MACRO_PITCH);
          UI_COLOR_CONFIG(GUI_COLOR_MACRO_WAVE);
          UI_COLOR_CONFIG(GUI_COLOR_MACRO_NOISE);
          UI_COLOR_CONFIG(GUI_COLOR_MACRO_FILTER);
          UI_COLOR_CONFIG(GUI_COLOR_MACRO_ENVELOPE);
          UI_COLOR_CONFIG(GUI_COLOR_MACRO_GLOBAL);
          UI_COLOR_CONFIG(GUI_COLOR_MACRO_OTHER);
          UI_COLOR_CONFIG(GUI_COLOR_MACRO_HIGHLIGHT);
          ImGui::TreePop();
        }
        if (ImGui::TreeNode(_("Multi-instrument Play"))) {
          UI_COLOR_CONFIG(GUI_COLOR_MULTI_INS_1);
          UI_COLOR_CONFIG(GUI_COLOR_MULTI_INS_2);
          UI_COLOR_CONFIG(GUI_COLOR_MULTI_INS_3);
          UI_COLOR_CONFIG(GUI_COLOR_MULTI_INS_4);
          UI_COLOR_CONFIG(GUI_COLOR_MULTI_INS_5);
          UI_COLOR_CONFIG(GUI_COLOR_MULTI_INS_6);
          UI_COLOR_CONFIG(GUI_COLOR_MULTI_INS_7);
          ImGui::TreePop();
        }
        if (ImGui::TreeNode(_("Instrument Types"))) {
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_FM);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_STD);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_T6W28);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_GB);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_C64);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_AMIGA);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_PCE);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_AY);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_AY8930);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_TIA);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_SAA1099);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_VIC);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_PET);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_VRC6);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_VRC6_SAW);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_OPLL);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_OPL);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_FDS);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_VBOY);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_N163);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_SCC);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_OPZ);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_POKEY);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_BEEPER);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_SWAN);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_MIKEY);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_VERA);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_X1_010);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_ES5506);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_MULTIPCM);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_SNES);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_SU);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_NAMCO);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_OPL_DRUMS);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_OPM);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_NES);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_MSM6258);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_MSM6295);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_ADPCMA);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_ADPCMB);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_SEGAPCM);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_QSOUND);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_YMZ280B);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_RF5C68);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_MSM5232);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_K007232);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_GA20);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_POKEMINI);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_SM8521);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_PV1000);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_K053260);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_TED);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_C140);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_C219);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_ESFM);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_POWERNOISE);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_POWERNOISE_SLOPE);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_DAVE);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_NDS);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_GBA_DMA);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_GBA_MINMOD);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_BIFURCATOR);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_SID2);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_SUPERVISION);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_UPD1771C);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_SID3);
          UI_COLOR_CONFIG(GUI_COLOR_INSTR_UNKNOWN);
          ImGui::TreePop();
        }
        if (ImGui::TreeNode(_("Channel"))) {
          UI_COLOR_CONFIG(GUI_COLOR_CHANNEL_BG);
          UI_COLOR_CONFIG(GUI_COLOR_CHANNEL_FG);
          UI_COLOR_CONFIG(GUI_COLOR_CHANNEL_FM);
          UI_COLOR_CONFIG(GUI_COLOR_CHANNEL_PULSE);
          UI_COLOR_CONFIG(GUI_COLOR_CHANNEL_NOISE);
          UI_COLOR_CONFIG(GUI_COLOR_CHANNEL_PCM);
          UI_COLOR_CONFIG(GUI_COLOR_CHANNEL_WAVE);
          UI_COLOR_CONFIG(GUI_COLOR_CHANNEL_OP);
          UI_COLOR_CONFIG(GUI_COLOR_CHANNEL_MUTED);
          ImGui::TreePop();
        }
        if (ImGui::TreeNode(_("Pattern"))) {
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_BG);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_PLAY_HEAD);
          UI_COLOR_CONFIG(GUI_COLOR_EDITING);
          UI_COLOR_CONFIG(GUI_COLOR_EDITING_CLONE);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_CURSOR);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_CURSOR_HOVER);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_CURSOR_ACTIVE);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_SELECTION);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_SELECTION_HOVER);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_SELECTION_ACTIVE);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_HI_1);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_HI_2);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_ROW_INDEX);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_ROW_INDEX_HI1);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_ROW_INDEX_HI2);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_ACTIVE);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_ACTIVE_HI1);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_ACTIVE_HI2);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_INACTIVE);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_INACTIVE_HI1);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_INACTIVE_HI2);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_INS);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_INS_WARN);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_INS_ERROR);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_VOLUME_MIN);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_VOLUME_HALF);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_VOLUME_MAX);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_EFFECT_INVALID);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_EFFECT_PITCH);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_EFFECT_VOLUME);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_EFFECT_PANNING);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_EFFECT_SONG);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_EFFECT_TIME);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_EFFECT_SPEED);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_EFFECT_SYS_PRIMARY);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_EFFECT_SYS_SECONDARY);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_EFFECT_MISC);
          UI_COLOR_CONFIG(GUI_COLOR_EE_VALUE);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_STATUS_OFF);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_STATUS_REL);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_STATUS_REL_ON);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_STATUS_ON);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_STATUS_VOLUME);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_STATUS_PITCH);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_STATUS_PANNING);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_STATUS_SYS1);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_STATUS_SYS2);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_STATUS_MIXING);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_STATUS_DSP);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_STATUS_NOTE);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_STATUS_MISC1);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_STATUS_MISC2);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_STATUS_MISC3);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_STATUS_ATTACK);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_STATUS_DECAY);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_STATUS_SUSTAIN);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_STATUS_RELEASE);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_STATUS_DEC_LINEAR);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_STATUS_DEC_EXP);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_STATUS_INC);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_STATUS_BENT);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_STATUS_DIRECT);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_STATUS_WARNING);
          UI_COLOR_CONFIG(GUI_COLOR_PATTERN_STATUS_ERROR);
          ImGui::TreePop();
        }
        if (ImGui::TreeNode(_("Sample Editor"))) {
          UI_COLOR_CONFIG(GUI_COLOR_SAMPLE_BG);
          UI_COLOR_CONFIG(GUI_COLOR_SAMPLE_FG);
          UI_COLOR_CONFIG(GUI_COLOR_SAMPLE_TIME_BG);
          UI_COLOR_CONFIG(GUI_COLOR_SAMPLE_TIME_FG);
          UI_COLOR_CONFIG(GUI_COLOR_SAMPLE_LOOP);
          UI_COLOR_CONFIG(GUI_COLOR_SAMPLE_CENTER);
          UI_COLOR_CONFIG(GUI_COLOR_SAMPLE_GRID);
          UI_COLOR_CONFIG(GUI_COLOR_SAMPLE_SEL);
          UI_COLOR_CONFIG(GUI_COLOR_SAMPLE_SEL_POINT);
          UI_COLOR_CONFIG(GUI_COLOR_SAMPLE_NEEDLE);
          UI_COLOR_CONFIG(GUI_COLOR_SAMPLE_NEEDLE_PLAYING);
          UI_COLOR_CONFIG(GUI_COLOR_SAMPLE_LOOP_POINT);
          UI_COLOR_CONFIG(GUI_COLOR_SAMPLE_LOOP_HINT);
          UI_COLOR_CONFIG(GUI_COLOR_SAMPLE_CHIP_DISABLED);
          UI_COLOR_CONFIG(GUI_COLOR_SAMPLE_CHIP_ENABLED);
          UI_COLOR_CONFIG(GUI_COLOR_SAMPLE_CHIP_WARNING);
          ImGui::TreePop();
        }
        if (ImGui::TreeNode(_("Pattern Manager"))) {
          UI_COLOR_CONFIG(GUI_COLOR_PAT_MANAGER_NULL);
          UI_COLOR_CONFIG(GUI_COLOR_PAT_MANAGER_UNUSED);
          UI_COLOR_CONFIG(GUI_COLOR_PAT_MANAGER_USED);
          UI_COLOR_CONFIG(GUI_COLOR_PAT_MANAGER_OVERUSED);
          UI_COLOR_CONFIG(GUI_COLOR_PAT_MANAGER_EXTREMELY_OVERUSED);
          UI_COLOR_CONFIG(GUI_COLOR_PAT_MANAGER_COMBO_BREAKER);
          ImGui::TreePop();
        }
        if (ImGui::TreeNode(_("Piano"))) {
          UI_COLOR_CONFIG(GUI_COLOR_PIANO_BACKGROUND);
          UI_COLOR_CONFIG(GUI_COLOR_PIANO_KEY_TOP);
          UI_COLOR_CONFIG(GUI_COLOR_PIANO_KEY_TOP_HIT);
          UI_COLOR_CONFIG(GUI_COLOR_PIANO_KEY_TOP_ACTIVE);
          UI_COLOR_CONFIG(GUI_COLOR_PIANO_KEY_BOTTOM);
          UI_COLOR_CONFIG(GUI_COLOR_PIANO_KEY_BOTTOM_HIT);
          UI_COLOR_CONFIG(GUI_COLOR_PIANO_KEY_BOTTOM_ACTIVE);
          ImGui::TreePop();
        }
        if (ImGui::TreeNode(_("Clock"))) {
          UI_COLOR_CONFIG(GUI_COLOR_CLOCK_TEXT);
          UI_COLOR_CONFIG(GUI_COLOR_CLOCK_BEAT_LOW);
          UI_COLOR_CONFIG(GUI_COLOR_CLOCK_BEAT_HIGH);

          ImGui::TreePop();
        }
        if (ImGui::TreeNode(_("Patchbay"))) {
          UI_COLOR_CONFIG(GUI_COLOR_PATCHBAY_PORTSET);
          UI_COLOR_CONFIG(GUI_COLOR_PATCHBAY_PORT);
          UI_COLOR_CONFIG(GUI_COLOR_PATCHBAY_PORT_HIDDEN);
          UI_COLOR_CONFIG(GUI_COLOR_PATCHBAY_CONNECTION);
          UI_COLOR_CONFIG(GUI_COLOR_PATCHBAY_CONNECTION_BG);

          ImGui::TreePop();
        }
        if (ImGui::TreeNode(_("Memory Composition"))) {
          UI_COLOR_CONFIG(GUI_COLOR_MEMORY_BG);
          UI_COLOR_CONFIG(GUI_COLOR_MEMORY_DATA);
          UI_COLOR_CONFIG(GUI_COLOR_MEMORY_FREE);
          //UI_COLOR_CONFIG(GUI_COLOR_MEMORY_PADDING);
          UI_COLOR_CONFIG(GUI_COLOR_MEMORY_RESERVED);
          UI_COLOR_CONFIG(GUI_COLOR_MEMORY_SAMPLE);
          UI_COLOR_CONFIG(GUI_COLOR_MEMORY_SAMPLE_ALT1);
          UI_COLOR_CONFIG(GUI_COLOR_MEMORY_SAMPLE_ALT2);
          UI_COLOR_CONFIG(GUI_COLOR_MEMORY_SAMPLE_ALT3);
          UI_COLOR_CONFIG(GUI_COLOR_MEMORY_WAVE_RAM);
          UI_COLOR_CONFIG(GUI_COLOR_MEMORY_WAVE_STATIC);
          UI_COLOR_CONFIG(GUI_COLOR_MEMORY_ECHO);
          UI_COLOR_CONFIG(GUI_COLOR_MEMORY_N163_LOAD);
          UI_COLOR_CONFIG(GUI_COLOR_MEMORY_N163_PLAY);
          UI_COLOR_CONFIG(GUI_COLOR_MEMORY_BANK0);
          UI_COLOR_CONFIG(GUI_COLOR_MEMORY_BANK1);
          UI_COLOR_CONFIG(GUI_COLOR_MEMORY_BANK2);
          UI_COLOR_CONFIG(GUI_COLOR_MEMORY_BANK3);
          UI_COLOR_CONFIG(GUI_COLOR_MEMORY_BANK4);
          UI_COLOR_CONFIG(GUI_COLOR_MEMORY_BANK5);
          UI_COLOR_CONFIG(GUI_COLOR_MEMORY_BANK6);
          UI_COLOR_CONFIG(GUI_COLOR_MEMORY_BANK7);

          ImGui::TreePop();
        }
        if (ImGui::TreeNode(_("Tuner"))) {
          UI_COLOR_CONFIG(GUI_COLOR_TUNER_NEEDLE);
          UI_COLOR_CONFIG(GUI_COLOR_TUNER_SCALE_LOW);
          UI_COLOR_CONFIG(GUI_COLOR_TUNER_SCALE_HIGH);
          ImGui::TreePop();
        }
        if (ImGui::TreeNode(_("Log Viewer"))) {
          UI_COLOR_CONFIG(GUI_COLOR_LOGLEVEL_ERROR);
          UI_COLOR_CONFIG(GUI_COLOR_LOGLEVEL_WARNING);
          UI_COLOR_CONFIG(GUI_COLOR_LOGLEVEL_INFO);
          UI_COLOR_CONFIG(GUI_COLOR_LOGLEVEL_DEBUG);
          UI_COLOR_CONFIG(GUI_COLOR_LOGLEVEL_TRACE);
          ImGui::TreePop();
        }
        END_SECTION;
      }
